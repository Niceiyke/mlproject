...
class DataTransformation:
    ...
    def get_data_transformer_obj(self):
        ...
        try:
            ...
            logging.info("numerical standard ecoding completed")
            ...
            logging.info("Categorical columns oneHotEncoder completed")
            ...
            preprocessor = ColumnTransformer(
                [
                    ("numerical_pipepline", numerical_pipepline, numerical_columns),
                    ("categorical_pipepline",categorical_pipeline,categorical_columns),
                ]
            )
